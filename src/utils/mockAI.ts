import { ShipmentData, AIRecommendation } from '../types';

export const generateAIRecommendation = (shipment: ShipmentData): AIRecommendation => {
  ...
  switch (shipment.product) {
    case 'Ice Cream':
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-15T22:00',
        coolingPlan: 'Pre-chill to -22°C, then maintain -18°C throughout journey',
        defaultFuel: 25,
        cciaFuel: 15,
        fuelSaved: 40,
        co2Avoided: 26,
    ...
    case 'Paneer':
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-16T05:00',
        ...
        co2Avoided: 15,
        spoilageRisk: 'Low',
        routeOptimization: 'Early morning departure with temperature monitoring',
      };
    
    case 'Chicken':
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-16T04:00',
        coolingPlan: 'Maintain -1°C to 0°C with strict temperature control',
        defaultFuel: 22,
        cciaFuel: 16,
        fuelSaved: 27,
        co2Avoided: 18,
    ...
    case 'Frozen Peas':
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-16T20:00',
    ...
    case 'Flavored Milk':
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-16T06:00',
    ...
    case 'Curd':
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-16T07:00',
    ...
    default:
      return {
        ...baseRecommendation,
        recommendedDeparture: '2025-01-16T08:00',
